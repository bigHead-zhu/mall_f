<template>
	<div class="food-goods">
		...
		<div class="goods-all">
			...
			<div class="goods-pro">
				<div class="couple">
					...
					<div class="tr" v-show="shopData.coupons>0">领券<img class="icon-return" src="../../../static/img/icon-r-return.png"  @click="goCouple(shopData.merchantId)"/></div>
					<div class="tr" v-show="shopData.coupons==0">暂无优惠券</div>
				</div>
				<div class="couple">
		...
		<!-- 购物导航-->
		<div class="car-foot">
			<div class="car-icon"><img class="goods-home" src="../../../static/img/goods-home.png" /></div>
	...
	import common from '../../plugins/common.js';
		...
		export default {
			...
			methods: {
				...
				// 详情
				detail(){
					food.detail(this.params).then(res =>{
						console.log(res)
						let code = res.code;
						if(code == 0){
