    ...
    <div class="details">
        <div class="order-details" v-for="(item,index) in orderlist" :key="index">
            ...
            <div class="details-price">
                ...
                <p class="price-last">￥{{item.totalAmount}}</p>    
            </div>
			<div class="btns" v-if="item.status == 0">
				<div class="cffb-btns">付款</div>
				<div class="gray-btns">取消订单</div>
			</div>
            <div class="confirm" v-if="item.status == 1">提醒发货</div>
            <div class="confirm" v-if="item.status == 2">确认收货</div>
            <div class="confirm" v-if="item.status == 3">待评论</div>
            <div class="confirm" v-if="item.status == 4">订单完成</div>
